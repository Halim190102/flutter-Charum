...
final tabHomeIndexProvider3 = StateProvider((ref) => 0);
final homeBucket3 = StateProvider((ref) => PageStorageBucket());
...
class Home3 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final PageStorageBucket bucket = ref.watch(homeBucket3);
    final activeTab = ref.watch(tabHomeIndexProvider3);
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          bottom: TabBar(
            onTap: (value) {
              ref.read(tabHomeIndexProvider3.notifier).state = value;
            },
