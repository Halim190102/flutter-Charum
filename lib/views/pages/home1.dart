...
final tabHomeIndexProvider1 = StateProvider((ref) => 0);
final homeBucket1 = StateProvider((ref) => PageStorageBucket());
...
class Home1 extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final PageStorageBucket bucket = ref.watch(homeBucket1);
    final activeTab = ref.watch(tabHomeIndexProvider1);
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          bottom: TabBar(
            onTap: (value) {
              ref.read(tabHomeIndexProvider1.notifier).state = value;
            },
